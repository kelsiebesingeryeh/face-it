      ...
      <Route
        ...
        render={({ match }) => {
          if (
            ...
            return (
              <Items data={this.state.vegan} type="blush" category="vegan" />
            );
          } else if (
            match.params.category === "vegan" &&
            ...
            return (
              <Items data={this.state.vegan} type="mascara" category="vegan" />
            );
          } else if (
            match.params.category === "vegan" &&
            ...
            return (
              <Items data={this.state.vegan} type="bronzer" category="vegan" />
            );
          } else if (
            match.params.category === "vegan" &&
            ...
            return (
              <Items data={this.state.vegan} type="eyeliner" category="vegan" />
            );
          } else if (
            match.params.category === "vegan" &&
            ...
            return (
              <Items data={this.state.vegan} type="lipstick" category="vegan" />
            );
          } else if (
            match.params.category === "vegan" &&
            ...
            return <Items data={this.state.eco} type="blush" category="eco" />;
          } else if (
            match.params.category === "eco" &&
            match.params.type === "eyeshadow"
          ) {
            return (
              <Items data={this.state.eco} type="eyeshadow" category="eco" />
            );
          } else if (
            match.params.category === "eco" &&
            match.params.type === "foundation"
            ...
            return (
              <Items data={this.state.eco} type="foundation" category="eco" />
            );
          } else if (
            match.params.category === "eco" &&
            match.params.type === "mascara"
            ...
            return (
              <Items data={this.state.eco} type="lip_liner" category="eco" />
            );
          } else if (
            match.params.category === "eco" &&
            match.params.type === "nail_polish"
            ...
            return (
              <Items data={this.state.eco} type="nail_polish" category="eco" />
            );
          } else if (
            match.params.category === "eco" &&
